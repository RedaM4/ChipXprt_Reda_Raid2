...
HD_PWD='/home/cenema/Desktop/Xilinx_Projects/ChipXprt_Reda_Raid2/DSD/assiginment2/Task2/Task2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Task2_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Task2_top.tcl
