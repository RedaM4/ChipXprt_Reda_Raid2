...
HD_PWD='/home/it/chipxprt/ChipXprt_Reda_Raid2/DSD/assiginment2/Task3/Task2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Task3_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Task3_top.tcl -notrace
