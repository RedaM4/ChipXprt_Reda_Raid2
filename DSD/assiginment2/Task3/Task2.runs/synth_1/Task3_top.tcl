...
set_param synth.incrementalSynthesisCache ./.Xil/Vivado-12689-IT-RDIA-NSH/incrSyn
...
synth_design -top Task3_top -part xc7a100tcsg324-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef Task3_top.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file Task3_top_utilization_synth.rpt -pb Task3_top_utilization_synth.pb"
